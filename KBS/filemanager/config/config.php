...
$upload_dir = '/filemanager/data/uploads/'; // path from base_url to base of upload folder (with start and final /)
$current_path = 'data/uploads/'; // relative path from filemanager folder to upload folder (with final /)
...
$default_language 	= "nl"; //default language file name
